export const APIs = () => {
  return {
    ...
    getWebScrappedRealTimeStockDetailsAndUpdatePosition:(stock:string,position?:string)=>`/get-scraped-real-time-stock-details-and-update-position?stock=${stock}&position=${position}`
  };
};
